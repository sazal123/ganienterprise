              ...
              <li>
                ...
                <div class="collapse" id="sidebar-users">
                  <ul class="nav-second-level">
                    ...
                    <li>
                      <a href="<?php echo e(route('customers.create')); ?>"><i data-feather="user-plus"></i> Add Customer</a>
                    </li>
                    <li>
              ...
              <li>
                ...
                <div class="collapse" id="sitebar-report">
                  <ul class="nav-second-level">
                    ...
                    <li>
                      <a href="<?php echo e(route('customers.report')); ?>"><i data-feather="file-plus"></i> Customer Report</a>
                    </li>
                    <li>
...
<?php /**PATH /Users/smgiyasuddin/ecommerce/ganienterprise/resources/views/backEnd/layouts/master.blade.php ENDPATH**/ ?>