            ...
            <div class="col-sm-12">
              <div class="card bg-light mb-3">
                ...
                <div class="card-body">
                  <div class="row mb-3">
                    <div class="col-sm-12">
                      <label for="proSize" class="form-label">Select Sizes</label>
                      <select class="form-control select2" id="proSizeSelect" multiple="multiple">
                        <?php $__currentLoopData = $sizes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $size): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($size->id); ?>" data-name="<?php echo e($size->sizeName); ?>"><?php echo e($size->sizeName); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                      </select>
                    </div>
                  </div>
            ...
            <div class="col-sm-12">
              <div class="card bg-light mb-3">
                ...
                <div class="card-body">
                  <div class="row mb-3">
                    <div class="col-sm-12">
                      <label for="proColor" class="form-label">Select Colors</label>
                      <select class="form-control select2" id="proColorSelect" multiple="multiple">
                        <?php $__currentLoopData = $colors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $color): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($color->id); ?>" data-name="<?php echo e($color->colorName); ?>"><?php echo e($color->colorName); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                      </select>
                    </div>
                  </div>
...
<script type="text/javascript">
  ...
  // ===== Dynamic Size Variants =====
  $('#proSizeSelect').on('change', function() {
    ...
    selected.forEach(function(id) {
      if (!currentRows.includes(id)) {
        var name = $('#proSizeSelect option[value="' + id + '"]').data('name');
    ...
    if ($('#sizeVariantBody tr').length === 1 && $('#noSizeRow').is(':visible') === false) {
      // Check if only noSizeRow visible
      var visibleRows = $('#sizeVariantBody tr:visible').length;
      if (visibleRows === 0) {
        $('#noSizeRow').show();
      }
    }
  ...
  $(document).on('click', '.remove-size-variant', function() {
    var id = $(this).data('id');
    $('#sizeRow_' + id).remove();
    $('#proSizeSelect option[value="' + id + '"]').prop('selected', false);
    $('#proSizeSelect').trigger('change');
  ...
  // ===== Dynamic Color Variants =====
  $('#proColorSelect').on('change', function() {
    var selected = $(this).val() || [];
    var currentRows = [];
    ...
    selected.forEach(function(id) {
      if (!currentRows.includes(id)) {
        var name = $('#proColorSelect option[value="' + id + '"]').data('name');
  ...
  $(document).on('click', '.remove-color-variant', function() {
    var id = $(this).data('id');
    $('#colorRow_' + id).remove();
    $('#proColorSelect option[value="' + id + '"]').prop('selected', false);
    $('#proColorSelect').trigger('change');
...
<?php echo $__env->make('backEnd.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/smgiyasuddin/ecommerce/ganienterprise/resources/views/backEnd/product/create.blade.php ENDPATH**/ ?>