...
unset($__errorArgs, $__bag); ?>
              ...
              <div class="product_img">
                <?php $__currentLoopData = $edit_data->mainImages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  ...
                  <div class="row mb-3">
                    <div class="col-sm-12">
                      ...
                      <select class="form-control select2" id="proSizeEdit" multiple="multiple">
                        ...
                        <option value="<?php echo e($size->id); ?>" data-name="<?php echo e($size->sizeName); ?>"
                          <?php $__currentLoopData = $selectsizes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ss): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <?php if($size->id == $ss->size_id): ?> selected <?php endif; ?> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>>
                      ...
                      <div class="table-responsive">
                        <table class="table table-bordered mb-0" id="sizeVariantTable">
                          ...
                          <tbody id="sizeVariantBody">
                            <?php $hasSize = false; ?>
                            <?php $__currentLoopData = $selectsizes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ss): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php $hasSize = true; ?>
                            <tr id="sizeRow_<?php echo e($ss->size_id); ?>" data-id="<?php echo e($ss->size_id); ?>">
                              <td><?php echo e($ss->size->sizeName ?? 'N/A'); ?><input type="hidden" name="proSize[]" value="<?php echo e($ss->size_id); ?>"></td>
                              <td><input type="number" step="0.01" class="form-control form-control-sm" name="sizePrice[<?php echo e($ss->size_id); ?>]" placeholder="Price" value="<?php echo e($ss->price); ?>"></td>
                              <td><input type="number" class="form-control form-control-sm" name="sizeStock[<?php echo e($ss->size_id); ?>]" placeholder="Stock" value="<?php echo e($ss->stock); ?>"></td>
                              <td><button type="button" class="btn btn-danger btn-sm remove-size-variant" data-id="<?php echo e($ss->size_id); ?>"><i class="fa fa-trash"></i></button></td>
                            </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            <?php if(!$hasSize): ?>
                            <tr id="noSizeRow">
                  ...
                  <div class="row mb-3">
                    <div class="col-sm-12">
                      ...
                      <select class="form-control select2" id="proColorEdit" multiple="multiple">
                        ...
                        <option value="<?php echo e($color->id); ?>" data-name="<?php echo e($color->colorName); ?>"
                          <?php $__currentLoopData = $selectcolors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <?php if($color->id == $sc->color_id): ?> selected <?php endif; ?> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>>
                      ...
                      <div class="table-responsive">
                        <table class="table table-bordered mb-0" id="colorVariantTable">
                          ...
                          <tbody id="colorVariantBody">
                            <?php $hasColor = false; ?>
                            <?php $__currentLoopData = $selectcolors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php
                              $hasColor = true;
                              $colorImage = $edit_data->images()->where('color_id', $sc->color_id)->first();
                            ?>
                            <tr id="colorRow_<?php echo e($sc->color_id); ?>" data-id="<?php echo e($sc->color_id); ?>">
                              <td><?php echo e($sc->color->colorName ?? 'N/A'); ?><input type="hidden" name="proColor[]" value="<?php echo e($sc->color_id); ?>"></td>
                              <td><input type="number" step="0.01" class="form-control form-control-sm" name="colorPrice[<?php echo e($sc->color_id); ?>]" placeholder="Price" value="<?php echo e($sc->price); ?>"></td>
                              <td><input type="number" class="form-control form-control-sm" name="colorStock[<?php echo e($sc->color_id); ?>]" placeholder="Stock" value="<?php echo e($sc->stock); ?>"></td>
                              <td>
                                <input type="file" name="colorImage[<?php echo e($sc->color_id); ?>]" class="form-control form-control-sm">
                                <?php if($colorImage): ?>
                                <div class="mt-1">
                                  <img src="<?php echo e(asset($colorImage->image)); ?>" width="50" height="50" class="border" alt="">
                                  <a href="<?php echo e(route('products.image.destroy',['id'=>$colorImage->id])); ?>" class="btn btn-xs btn-danger waves-effect waves-light"><i class="mdi mdi-close"></i></a>
                                </div>
                                <?php endif; ?>
                              </td>
                              <td><button type="button" class="btn btn-danger btn-sm remove-color-variant" data-id="<?php echo e($sc->color_id); ?>"><i class="fa fa-trash"></i></button></td>
                            </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            <?php if(!$hasColor): ?>
                            <tr id="noColorRow">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="col-sm-3 mb-3">
              <div class="form-group">
                ...
                <label class="switch">
                  <input type="checkbox" value="1" name="is_new" <?php if($edit_data->is_new==1): ?>checked <?php endif; ?>>
                  <span class="slider round"></span>
                </label>
              </div>
            </div>
            ...
            <div class="col-sm-3 mb-3">
              <div class="form-group">
                ...
                <label class="switch">
                  <input type="checkbox" value="1" name="is_prime" <?php if($edit_data->is_prime==1): ?>checked <?php endif; ?>>
                  <span class="slider round"></span>
                </label>
              </div>
            </div>
...
<?php echo $__env->make('backEnd.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/smgiyasuddin/ganienterprise/resources/views/backEnd/product/edit.blade.php ENDPATH**/ ?>