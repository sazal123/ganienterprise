...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col mb-3">
                        <div class="form-group">
                            ...
                            <label class="switch">
                                <input type="checkbox" value="1" name="spotlight" <?php if($edit_data->spotlight==1): ?> checked <?php endif; ?>>
                                <span class="slider round"></span>
                            </label>
                        </div>
                    </div>
...
<?php echo $__env->make('backEnd.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/smgiyasuddin/ecommerce/ganienterprise/resources/views/backEnd/category/edit.blade.php ENDPATH**/ ?>