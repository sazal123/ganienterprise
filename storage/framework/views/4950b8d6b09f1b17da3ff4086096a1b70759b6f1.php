...
<div class="container-fluid">
   ...
   <div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                <form action="<?php echo e(route('customers.store')); ?>" method="POST" class="row" data-parsley-validate=""  enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <div class="col-sm-6">
...
unset($__errorArgs, $__bag); ?>" name="whatsapp" value="<?php echo e(old('whatsapp')); ?>" id="whatsapp">
...
unset($__errorArgs, $__bag); ?>" name="address" value="<?php echo e(old('address')); ?>" id="address">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group mb-3">
                            ...
                            <select class="form-control select2 <?php $__errorArgs = ['district'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="district" id="district">
                                <option value="">Select District</option>
                                <?php $__currentLoopData = $districts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $district): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($district->id); ?>" <?php if(old('district') == $district->id): ?> selected <?php endif; ?>><?php echo e($district->district); ?></option>
...
unset($__errorArgs, $__bag); ?>" name="area" value="<?php echo e(old('area')); ?>" id="area">
...
unset($__errorArgs, $__bag); ?>" name="feedback" id="feedback" rows="3"><?php echo e(old('feedback')); ?></textarea>
...
<?php echo $__env->make('backEnd.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/smgiyasuddin/ecommerce/ganienterprise/resources/views/backEnd/customer/create.blade.php ENDPATH**/ ?>