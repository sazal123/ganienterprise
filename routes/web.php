...
Route::group(['namespace'=>'Admin','middleware' => ['auth','lock','check_refer'],'prefix'=>'admin'], function() {
    ...
    Route::get('order/product-variants', [OrderController::class,'getProductVariants'])->name('admin.order.product_variants');
    ...
    Route::post('order/payment-store', [OrderController::class,'paymentStore'])->name('admin.order.payment_store');
    Route::post('order/payment-delete', [OrderController::class,'paymentDelete'])->name('admin.order.payment_delete');
    ...
    Route::get('stock-product-variants', [OrderController::class,'stockProductVariants'])->name('admin.stock_product_variants');
    ...
    Route::post('customer/store', [CustomerManageController::class,'store'])->name('customers.store');
    ...
    Route::get('customer/report', [CustomerManageController::class,'customerReport'])->name('customers.report');
    Route::post('customer/adminlog', [CustomerManageController::class,'adminlog'])->name('customers.adminlog');
    Route::post('customer/destroy', [CustomerManageController::class,'destroy'])->name('customers.destroy');
