...
<section class="categories-section py-5">
    <div class="container">
        <div class="row">
            <div class="col-md-6">
                <div class="category-banner banner-1">
                    <img src="{{ asset('frontEnd/images/banner1.jpg') }}" alt="Category Banner" class="w-100">
                </div>
            </div>
            <div class="col-md-6">
                <div class="category-banner banner-2">
                    <img src="{{ asset('frontEnd/images/banner2.jpg') }}" alt="Category Banner" class="w-100">
                </div>
            </div>
        </div>
    </div>
