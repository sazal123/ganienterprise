        ...
        <div class="shop-toolbar">
            <div class="shop-toolbar-left">
                ...
                <div class="showing-data">
                    Showing <strong>{{ $products->firstItem() }}</strong>–<strong>{{ $products->lastItem() }}</strong> of <strong>{{ $products->total() }}</strong> results
                </div>
            </div>
        ...
        <div class="row">
                        ...
                        <div class="shop-sidebar-body" id="sidebarCategories">
                            <ul class="shop-cat-list">
                                ...
                                <li class="shop-cat-item">
                                    ...
                                    @endphp
                                    @if($subcats->count() > 0)
                                    <button class="shop-cat-toggle" data-toggle="subcat" data-target="#subcat-{{ $category->id }}">
                                        <span>{{ $category->name }}</span>
                                        <i class="fa fa-chevron-right"></i>
                                    </button>
                                    <ul class="shop-subcat-list" id="subcat-{{ $category->id }}">
                                        <li class="shop-subcat-item">
                                            <a href="{{ route('category', $category->slug) }}" class="shop-subcat-link {{ $catActive ? 'active' : '' }}">
                                                {{ $category->name }} (All)
                                            </a>
                                        </li>
                                        @foreach($subcats as $subcat)
                                        <li class="shop-subcat-item">
                                            <a href="{{ url('subcategory/'.$subcat->slug) }}" class="shop-subcat-link">
                                    ...
                                    @else
                                    <a href="{{ route('category', $category->slug) }}" class="shop-cat-link {{ $catActive ? 'active' : '' }}">
                                        <span>{{ $category->name }}</span>
                                    </a>
                                    @endif
                                </li>
                            ...
                            <div class="shop-price-range">
                                <form action="" method="GET" id="priceFilterForm">
                                    ...
                                    <div class="price-inputs">
                                        <div class="price-input-group">
                                            ...
                                            <input type="text" name="min_price" id="price_min"
                                                   value="{{ request()->get('min_price', floor($globalMin ?? 0)) }}"
                                                   readonly />
                                        </div>
                                        ...
                                        <div class="price-input-group">
                                            ...
                                            <input type="text" name="max_price" id="price_max"
                                                   value="{{ request()->get('max_price', ceil($globalMax ?? 10000)) }}"
                                                   readonly />
                                        </div>
                                    </div>
                                    ...
                                    <div class="price-filter-actions">
                                        ...
                                        <a href="{{ route('shop') }}" class="btn-price-reset">Reset</a>
                                    </div>
                                </form>
                            </div>
                        </div>
                        ...
                        <div class="shop-sidebar-body" id="sidebarFilter">
                            <form action="" method="GET" id="filterForm">
                                ...
                                <ul class="shop-filter-list">
                                    <li class="shop-filter-item">
                                        <label class="shop-filter-label">
                                            <input type="radio" name="category_filter" value=""
                                                   {{ !request()->get('category_filter') ? 'checked' : '' }} />
                                    ...
                                    <li class="shop-filter-item">
                                        <label class="shop-filter-label">
                                            <input type="radio" name="category_filter" value="{{ $category->slug }}"
                                                   {{ request()->get('category_filter') == $category->slug ? 'checked' : '' }} />
            ...
            <div class="col-lg-9">
                ...
                <div class="shop-empty">
                    ...
                    <a href="{{ route('shop') }}" class="btn-price-filter" style="display:inline-block;padding:10px 30px;text-decoration:none;">View All Products</a>
                </div>
                @endif
            </div>
        </div>
